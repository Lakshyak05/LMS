    ...
    <div className='relative md:px-36 px-8 pt-20 text-left'>
      <div className='flex md:flex-row flex-col gap-6 items-start justify-between w-full'>
        ...
        <p className='text-gray-500'>
          <span className='text-blue-700 cursor-pointer' onClick={() => navigate('/')}> Home </span> / <span> Course List</span></p>
          </div>
          <SearchBar data={input} />
      </div>

      {
        input && <div className='inline-flex items-center gap-4 px-4 py-4 border border-gray-200 mt-8 -mb-8 text-gray-600'>
          <p>{input}</p>
